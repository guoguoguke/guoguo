...
public class XgUser extends PageDto{
	...
	public String toString() {
		return "XgUser [usercode=" + usercode + ", username=" + username + ", persontype=" + persontype + ", userflag="
				+ userflag + ", virtualuserflag=" + virtualuserflag + ", enrolldate=" + enrolldate + ", validstatus="
				+ validstatus + ", logoutdate=" + logoutdate + ", birthday=" + birthday + ", identifyno=" + identifyno
				+ ", homeaddress=" + homeaddress + ", mobile=" + mobile + ", ifmarried=" + ifmarried + ", nationality="
				+ nationality + ", position=" + position + ", primaryeducationexperience=" + primaryeducationexperience
				+ ", sex=" + sex + ", comcode=" + comcode + ", comcname=" + comcname + ", teamcode=" + teamcode
				+ ", teamname=" + teamname + ", roleid=" + roleid + ", rolename=" + rolename + ", levelid=" + levelid
				+ ", levelname=" + levelname + ", basewage=" + basewage + ", quality=" + quality + ", startdate="
